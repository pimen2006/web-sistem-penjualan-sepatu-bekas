...
<body class="bg-gradient-to-br from-blue-500 via-indigo-400 to-purple-500 min-h-screen flex items-center justify-center">
    <div class="container mx-auto px-4">
        <div class="max-w-lg mx-auto bg-white p-8 rounded-3xl shadow-xl ring-1 ring-gray-300">
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-8">Edit Admin Profile</h2>
