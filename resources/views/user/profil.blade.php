...
<body class="bg-gradient-to-r from-sky-300 via-indigo-200 to-purple-300">
    ...
    <div class="container mx-auto p-6">
        <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg space-y-6">
            <div class="text-center">
                <h2 class="text-3xl font-semibold text-indigo-600 mb-4">Profile Information</h2>
            </div>

            <!-- Profile Picture Section -->
            <div class="flex items-center justify-center">
                <div class="flex flex-col items-center">
                    <strong class="text-lg text-gray-700">Profile Picture</strong>
                    <div
                        class="w-32 h-32 mt-4 bg-gray-100 rounded-full overflow-hidden flex items-center justify-center">
                        @if (Auth::user()->profile_picture)
                            <img src="{{ asset('uploads/user/' . Auth::user()->profile_picture) }}"
                                alt="Profile Picture" class="w-full h-full object-cover">
                        @else
                            <p class="text-center text-gray-500">No profile picture</p>
                        @endif
                    </div>
                </div>
            </div>
